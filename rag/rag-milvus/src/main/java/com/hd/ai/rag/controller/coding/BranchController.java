...
public class BranchController {
    ...
    @PostMapping("/list")
    public AjaxResult<Branch> list(String title, Integer currentPage, Integer pageSize) {
        return AjaxResult.success(branchService.list(title,currentPage,pageSize));
    }
}
