...
public class OpenMeteoService {
    ...
    public String getWeatherForecastByLocation(@ToolParam(description = "地理位置坐标精度") double latitude,@ToolParam(description = "地理位置坐标纬度")  double longitude) {
        // 获取天气数据（当前和未来7天）
